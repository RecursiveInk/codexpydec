...
class CodexDecoder:
    ...
    def _recursive_catalog_search(
        ...
        entry_title = first_entry_bytes[self.pointer_length :].decode("utf-8")
        if search_query < entry_title.lower():
        ...
        entry_title = last_entry_bytes[self.pointer_length :].decode("utf-8")
        if search_query > entry_title.lower():
            return self._recursive_catalog_search(
